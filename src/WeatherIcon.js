...
const weatherCode2Type = weatherCode =>
  Object.entries(weatherTypes).reduce((currentWeatherType, [weatherType, weatherCodes]) => (weatherCodes.includes(Number(weatherCode)) ? weatherType : currentWeatherType), "");
